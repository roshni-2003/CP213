...
public class InnerClassPanel extends JPanel {
	...
	public void itemStateChanged(final ItemEvent e) {
		...
		checkBoxesSelected.add(str);
	    }

	    else if (ItemEvent.DESELECTED == e.getStateChange()) {
		checkBoxesSelected.remove(str);
	    }
	}
    }
	...
	public void stateChanged(final ChangeEvent e) {
	    ...
	    InnerClassPanel.this.spinnerSet = (String) source.getValue();
	...
	this.checkBoxesSelected.addItemListener(new CheckBoxListener());
